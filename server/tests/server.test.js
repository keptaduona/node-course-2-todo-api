...
describe('GET /todos/:id', () => {
  ...
  it('should not return a todo doc created by other user', (done) => {
    request(app)
    //try to get 1st users todo authed as 2nd user
...
describe('POST /users', () => {
  it('should create a user', (done) => {
    ...
    request(app)
      ...
      .expect(200)
      .expect((res) => {
        expect(res.headers['x-auth']).toExist(); //we use [] notation instead of dot notation because dash wouldnt work in dot notation
...
//if we dont catch and error occurs, test will time out
        }).catch((e) => done(e));
      })
  });
